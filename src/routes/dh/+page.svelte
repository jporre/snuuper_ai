			...
			<ul role="list" class="divide-y divide-gray-100">
				...
				<li class="z-50 flex items-center justify-between px-2 py-5 bg-gray-300 rounded-lg gap-x-6 hover:bg-gray-400 ">
					...
					<div class="flex items-center flex-none gap-x-4">
						<a href="/dh/tareas/{tarea._id}" class="hidden rounded-md bg-white px-2.5 py-1.5 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:block">Ver Tarea<span class="sr-only">, GraphQL API</span></a>
