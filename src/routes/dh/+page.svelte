...
<section>
	<div class="flex w-1/5 flex-col items-start justify-between relative rounded-3xl p-3 border border-gray-700/70 bg-background shadow-md mb-3">
	...
	<div class="grid grid-cols-5 gap-4">
		<div class="col-span-3">
			<ul role="list" class="divide-y divide-gray-100">
				...
				<li class="z-50 flex items-center justify-between gap-x-6 py-5 bg-gray-300 rounded-lg px-2 hover:bg-gray-400 ">
					<div class="min-w-0">
				...
				<li class="flex items-center justify-between gap-x-6 py-5 bg-gray-300 rounded-lg px-2 hover:bg-gray-400">
					<div class="min-w-0">
						<div class="flex items-start gap-x-3">
							<p class="text-sm font-semibold leading-6 text-gray-900">GraphQL API</p>
							<p class="mt-0.5 whitespace-nowrap rounded-md bg-green-50 px-1.5 py-0.5 text-xs font-medium text-green-700 ring-1 ring-inset ring-green-600/20">Complete</p>
